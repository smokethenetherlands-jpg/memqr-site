...
export async function handler(event, context) {
  ...
  if (event.httpMethod === "GET") { return json(405, { error: "Method Not Allowed", hint: "Use POST", ping: true }); }
  ...
  try {
    ...
    // Assemble message: list all key/value pairs
    const entries = Object.entries(data)
      .filter(([k]) => k.toLowerCase() !== "website"); // drop honeypot
